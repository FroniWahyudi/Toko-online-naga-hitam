...
<div class="card">
<div class="card-body">
<h5 class="card-title"> {{$judul}} </h5> <div class="table-responsive">
<table id="zero_config" class="table table-striped table-bordered"> <thead></thead>
<tr>
<th>No</th>
<th>Kategori</th>
<th>Status</th>
...
<td> Rp. {{ number_format($row->harga, 0, ',', '.') }} <td> {{ $row->stok }} </td>
<td>
<a href="{{ route('backend.produk.edit', $row->id) }}" <button type="button" class="btn btn-cyan btn-
</td>
title="Ubah Data">
